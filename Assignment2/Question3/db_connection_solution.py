...
# SPECIFICATION: Communicates with the database, inserting and deleting data into the tables
...
def connectDataBase():
    ...
    try:
        ...
        conn = psycopg2.connect(database="corpus", user="postgres", password="password", host="localhost", port="5432")
        return conn
